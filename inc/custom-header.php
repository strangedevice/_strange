...
function _strange_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( '_strange_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => '_strange_header_style',
		'admin-head-callback'    => '_strange_admin_header_style',
		'admin-preview-callback' => '_strange_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', '_strange_custom_header_setup' );

if ( ! function_exists( '_strange_header_style' ) ) :
/**
